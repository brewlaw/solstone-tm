...
if st.button("Execute Bridging Search"):
    ...
    with st.spinner("Searching USPTO via tmsearch.uspto.gov..."):
        ...
        # NOTE: Make sure this function is defined/imported at the top of your file!
...
if st.session_state.get('lop_step') == 3:
    ...
    # Add a blank checkbox column for the user to select rows
    if "Select" not in df.columns:
        df.insert(0, "Select", False)
    
    # Use Data Editor with Multiline text enabled for the Goods column
    edited_df = st.data_editor(
        ...
        column_config={
            ...
            "Goods": st.column_config.TextColumn("Filtered Goods", width="large") # Backup in case column is named differently
        }
    )